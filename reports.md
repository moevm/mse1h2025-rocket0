...
1) Была разработана инструкция по развертыванию бота рядом с уже существующим инстансом рокета.
2) Были поправлены баги связанные со сканированием чатов рокета.
3) Были доработаны вспомогательные флаги для поиска сообщений.

Скринкаст - /materials/video_4.webm
Презентация - /materials/rocket0_4_iter.pdf
...
## Итоги всего курса
1) Поиск тредов / каналов / вопросов без ответа н часов командой !find_unanswered и ее флагами
2) Составление статистики по пользователям / ролям / каналам командой !stats и ее флагами (статистика выгружается в csv файл)
3) Поиск сообщений по паттерну командой !find_message 
4) Обновление каналов взаимодействующих с ботом командой !refresh
5) Тестовая версия уведомления в телеграмм на примере команды !time
6) Файл конфигурации с параметрами бота (.env)
7) Логирование всех действий бота 
8) Инструкция по запуску бота с тестовым дампом
9) Инструкция по запуску бота с уже существующим инстансом чата

Презентация - /materials/rocket0_all.pdf
